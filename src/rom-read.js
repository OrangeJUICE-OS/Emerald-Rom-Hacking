...
import { OFFSETS, OFFSETS as OFS } from "./offsets";
...
export function getDexDataById(id){
  var flavorOffset = OFFSETS.PKMN_DEX_DATA + id * 0x20;
  var typeOffset = (OFFSETS.PKMN_DEX_DATA + id * 0x20) + 0x12;

  var flavor = readString(flavorOffset);
  console.log(readString(typeOffset));
